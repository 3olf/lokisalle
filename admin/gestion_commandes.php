...
<div class="container">
	...
	<h1>Back-office, Gestion des commandes</h1>
	...
	//données de la table :
		...
		while ($ligne=$resultat_liste_commande->fetch(PDO::FETCH_ASSOC)){
			...
			echo '<td><a href="'.URL.'fiche_produit.php?id='. $ligne['id_produit'] .'" class="btn btn-info" ><span class="glyphicon glyphicon-search"></span></a>';
			echo '<a href="?action=modification&id='. $ligne['id_commande'] .'" class="btn btn-warning" ><span class="glyphicon glyphicon-pencil"></span></a>';
			echo '<a href="?action=suppression&id='. $ligne['id_commande'] .'"  class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span></a>';
			echo "</td></tr>";
		}
