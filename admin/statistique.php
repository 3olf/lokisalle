                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Dashboard <small>Statistiques du mois dernier</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                               <span class="glyphicon glyphicon-dashboard"></span> Données de la période du <?php echo $one_month_ago->format('d/m/Y')." au ". $today->format('d/m/Y'); ?>  
                            </li>
                        </ol>
                    </div>
                </div>
